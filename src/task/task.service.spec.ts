...
describe('TaskService', () => {
  ...
  describe('createTask', () => {
    ...
    it('should throw if start date is in the past', async () => {
      const pastDto = {
        ...createTaskDto,
        expectedStartDate: '2000-01-01T00:00:00Z',
      };
      await expect(service.createTask(pastDto)).rejects.toThrow(
        BadRequestException,
      );
    });
  ...
  describe('findTasksByAccount', () => {
    it('should throw if no tasks found', async () => {
      ...
      await expect(service.findTasksByAccount(1)).rejects.toThrow(
        NotFoundException,
      );
    });
  ...
  describe('updateProgress', () => {
    ...
    it('should throw if task not found', async () => {
      ...
      await expect(service.updateProgress(updateProgressDto)).rejects.toThrow(
        HttpException,
      );
    });
