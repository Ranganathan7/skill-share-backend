export const swaggerAPIOptions = {
  ...
  getAccount: {
    ...
    description: 'This API is used to get account details',
  },
  createTask: {
    summary: 'Create task',
  ...
  getTasks: {
    summary: 'Get tasks',
    description:
      'This API returns all tasks the user has created / tasks that the provider has been offered',
  },
  makeOffer: {
    summary: 'Make offer',
  ...
  getOffers: {
    summary: 'Get offers',
    description:
      'This API is used to fetch offers made by provider / offers received for a task created by user',
  },
  acceptOffer: {
    summary: 'Accept offer',
    description:
      'This API is used to accept an offer from provider by the user',
  },
  updateTaskProgress: {
